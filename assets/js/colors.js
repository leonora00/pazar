var Color = (function (exports) {
	...
	class Color$1 {
		...
		get luminance () {
			...
			return Color$1.chromaticAdaptation(Color$1.spaces.xyz.white, Color$1.whites.D65, this.xyz)[1];
		}

		set luminance (value) {
			let xyz = Color$1.chromaticAdaptation(Color$1.spaces.xyz.white, Color$1.whites.D65, this.xyz);
			xyz[1] = value;
			xyz = Color$1.chromaticAdaptation(Color$1.whites.D65, Color$1.spaces.xyz.white, xyz);
			this.xyz.X = xyz[0];
			this.xyz.Y = xyz[1];
			this.xyz.Z = xyz[2];
		}
